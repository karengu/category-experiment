...
```{r}
# "all blickets squeak": 1, 52
# no mention of ringing: 4, 8, 24, 35
# no mention of squeaking: 57, 73, 95
# specific to generic: 0, 7, 11, 28, 33, 61, 90
# did not attempt to remember utterance: 47, 74, 106
# only specific: 2, 9, 16, 80
# failed sound check: 15, 100
# do not ring: 17
failed.attention <- c(0, 1, 2, 4, 7, 8, 9, 11, 15, 16, 17, 24, 28, 33, 35, 47, 52, 57, 61, 73, 74, 80, 90, 95, 100, 106)
# wrong: 23, 25, 32, 37, 42, 52, 74, 96, 100, 107
# confused: 0, 40, 57, 63, 69, 73, 106
wrong.or.confused <- c(0, 23, 25, 32, 37, 40, 42, 52, 57, 62, 69, 73, 74, 96, 100, 106, 107)
