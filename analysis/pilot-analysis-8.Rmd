...
```{r}
failed.attention <- c(0, 1, 6, 7, 8, 10, 11, 15, 16, 17, 20, 29, 33, 35, 36, 39, 41, 45, 48, 54, 55, 62, 66, 67, 68, 70, 71)
non.english <- c(30, 39, 53)
wrong.or.confused <- c(0, 30, 33, 39, 41, 45, 53, 71)
df.trials <- df.trials %>%
